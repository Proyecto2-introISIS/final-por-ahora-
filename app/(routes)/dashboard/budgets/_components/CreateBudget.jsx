...
function CreateBudget({ refreshData }) {
    ...
    const onCreateBudget = async () => {
        ...
        if (result) {
            refreshData()
            toast("Nuevo presupuesto creado")
        }
    }
    ...
    <Dialog>
        <DialogTrigger asChild>
            <div className="bg-[#824cff] p-10 rounded-md items-center flex flex-col border-2 border-dashed cursor-pointer hover:shadow-md">
                ...
                <h2 className="text-white">Crear nuevo presupuesto</h2>
            </div>
        </DialogTrigger>
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>
                    <div className="mt-5">
                        ...
                        <div className="mt-2">
                            <h2 className="text-black font-medium my-1">Nombre del presupuesto</h2>
                            <Input placeholder="Ejemplo: decoración para el hogar"
                                onChange={(e) => setName(e.target.value)} />
                        </div>
                        <div className="mt-2">
                            <h2 className="text-black font-medium my-1">Precio del presupuesto</h2>
                            <Input
                                type="number"
