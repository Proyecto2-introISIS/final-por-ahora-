...
function CardInfo({ budgetList }) {
  ...
  return (
    <div>
      {budgetList?.length > 0 ? (
        <div>
          <div className="p-7 border mt-4 -mb-1 rounded-2xl flex items-center justify-between bg-[#FFF7CE] text-black">
            <div className="">
          ...
          <div className="mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="p-7 border rounded-2xl flex items-center justify-between bg-[#FFE686] text-black">
              <div>
              ...
              <PiggyBank className="bg-[#8B17FF] p-3 h-12 w-12 rounded-full text-white" />
            </div>
            <div className="p-7 border rounded-2xl flex items-center justify-between bg-[#FFE686] text-black">
              <div>
              ...
              <ReceiptText className="bg-[#8B17FF] p-3 h-12 w-12 rounded-full text-white" />
            </div>
            <div className="p-7 border rounded-2xl flex items-center justify-between bg-[#FFE686] text-black">
              <div>
              ...
              <Wallet className="bg-[#8B17FF] p-3 h-12 w-12 rounded-full text-white" />
            </div>
          </div>
        </div>
      ) : (
